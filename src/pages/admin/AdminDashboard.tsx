...
export function AdminDashboard() {
  ...
  const handleSeedData = async () => {
    ...
    try {
      ...
      await batch.commit();
      showSuccess("Successfully loaded all existing content into the Database! You can now edit it in the admin panel.", "Database Populated");
    } catch (error) {
       showError("Failed to seed initial data. Please try again or check Firebase connectivity.", "Import Failed");
