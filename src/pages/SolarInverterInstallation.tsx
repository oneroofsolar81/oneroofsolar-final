...
export function SolarInverterInstallation() {
  ...
  return (
    <div className="bg-[#121814] text-slate-100 font-sans min-h-screen">
      ...
      {/* 2. WHAT DOES SOLAR INVERTER INSTALLATION INVOLVE IN DARWIN? (50/50 Layout: Left Image, Right Text) */}
      ...
      {/* 3. WHO NEEDS SOLAR INVERTER INSTALLATION IN DARWIN (3 Cards) */}
      ...
      {/* 4. WHERE THE INVERTER DEMAND IS COMING FROM ACROSS DARWIN (50/50 Layout: Left Text with Checklist, Right Image) */}
      <section className="py-16 lg:py-20 bg-[#0A1118] border-b border-white/5 relative">
        <div className="mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
      ...
      {/* 5. CTA BANNER 1 (Full-width rounded light green background, centered text and button) */}
      ...
      {/* 6. HOW WE INSTALL YOUR SOLAR INVERTER (6-step numbered process with circle badges) */}
      <section className="py-16 lg:py-24 bg-[#0A1118] border-b border-white/5 relative">
        <div className="mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-12 uppercase tracking-wide [word-spacing:0.12em] leading-tight text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {installSteps.map((step, idx) => (
                <div 
                  key={idx}
                  className="bg-[#0D1520] border border-white/10 p-7 sm:p-8 rounded-2xl sm:rounded-3xl shadow-xl flex flex-col justify-between h-full relative"
                >
                  <div>
                    <div className="w-12 h-12 rounded-full bg-[#5BC94D] text-[#19281D] font-black text-xl flex items-center justify-center mb-6 shadow-md shadow-[#5BC94D]/20">
                      {step.number}
                    </div>
                    <h3 className="text-xl font-bold text-white mb-3 tracking-wide capitalize">
                      {step.title}
                    </h3>
                    <p className="text-slate-300 text-base leading-relaxed font-medium">
                      {step.desc}
      ...
      {/* 7. INVERTER BRANDS WE INSTALL (Brand Card Row) */}
      <section className="py-16 lg:py-20 bg-[#121814] border-b border-white/5 relative">
        <div className="mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
              {brands.map((brand, idx) => (
                <div 
                  key={idx}
                  className="bg-[#0D1520] border border-white/10 p-6 rounded-2xl shadow-xl flex flex-col justify-center items-center text-center hover:border-[#5BC94D]/40 transition-colors"
                >
                  <div className="w-10 h-10 rounded-xl bg-[#5BC94D]/10 border border-[#5BC94D]/30 flex items-center justify-center text-[#5BC94D] mb-4">
      ...
      {/* 8. FREQUENTLY ASKED QUESTIONS (Accordion style) */}
      <section className="py-16 lg:py-24 bg-[#0A1118] border-b border-white/5 relative">
      ...
      {/* 9. END CTA BANNER (Full-width rounded light green background, centered text and button) */}
