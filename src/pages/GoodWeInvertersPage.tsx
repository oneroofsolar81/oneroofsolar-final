                ...
                <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-lg bg-slate-100">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-white/95 border border-slate-200 shadow-md">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-xs font-bold text-slate-900">Global Tier 1 Manufacturer</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
              ...
              <div className="bg-white border-2 border-slate-200 hover:border-[#8cc63f] rounded-2xl p-6 sm:p-8 shadow-sm transition-all flex flex-col justify-between">
                ...
                <div className="pt-4 border-t border-slate-100">
                  <span className="inline-block text-xs font-bold text-slate-500 uppercase tracking-wider">
