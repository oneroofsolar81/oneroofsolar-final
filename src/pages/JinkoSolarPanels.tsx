...
export function JinkoSolarPanels() {
    ...
    },
    {
      ...
      a: (
        <span>
          ...
          <RouterLink to="/services/solar-panel-installation" className="text-[#5BC94D] hover:underline font-bold">
    ...
    },
    {
      ...
      a: (
        <span>
          ...
          <RouterLink to="/services/battery-storage" className="text-[#5BC94D] hover:underline font-bold">
  ...
  return (
    <div className="bg-[#121814] text-slate-100 font-sans min-h-screen">
            ...
            <div className="lg:col-span-7">
              <FadeIn isHero>
                ...
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-slate-400 text-xs font-semibold uppercase tracking-wider mb-6 font-mono">
                  ...
                  <RouterLink to="/product/solar-panels-brands" className="hover:text-[#5BC94D] transition-colors">Solar Panels</RouterLink>
                  <span className="text-slate-500" aria-hidden="true">&gt;</span>
                  <span className="text-[#5BC94D]" aria-current="page">Jinko Solar Panels</span>
                </nav>
                ...
                <p className="text-base sm:text-lg text-slate-300 leading-relaxed font-medium border-l-2 border-[#5BC94D] pl-6 mb-8">
      ...
      <section className="py-12 lg:py-20 bg-[#0A1118] border-b border-white/5 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              <div className="bg-slate-900/50 p-6 sm:p-8 rounded-2xl border border-white/5">
      ...
      <section className="py-12 md:py-16 lg:py-[80px] bg-[#121814] border-b border-white/5 relative">
        <div className="mx-auto max-w-[1220px] px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-14">
            ...
            <div className="w-full lg:w-[47%] shrink-0">
              <FadeIn>
                <h2 className="text-[28px] sm:text-[36px] lg:text-[44px] font-black text-white uppercase tracking-wide [word-spacing:0.12em] leading-[1.08] mb-6 max-w-[560px]">
                  Jinko N-Type TOPCon Technology
                </h2>
                <p className="text-slate-300 text-base lg:text-[17px] leading-[1.68] mb-6 max-w-[560px]">
                ...
                <p className="text-slate-300 text-base lg:text-[17px] leading-[1.68] max-w-[560px]">
            ...
            <div className="w-full lg:w-[53%] shrink-0 flex justify-center lg:justify-end">
              <FadeIn delay={0.2} className="w-full max-w-[620px]">
                <div className="bg-[#0D1520] rounded-2xl p-5 sm:p-6 border border-white/10 shadow-xl w-full">
      ...
      <section className="py-12 lg:py-24 bg-[#0A1118] border-b border-white/5 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="overflow-x-auto rounded-2xl border border-white/10 bg-slate-900/60 shadow-xl">
              <table className="w-full text-left border-collapse min-w-[600px]">
                <thead>
                  <tr className="bg-slate-950 border-b border-white/10 text-white font-black text-sm uppercase tracking-wider">
                    <th className="p-4 sm:p-5">Specification</th>
                    <th className="p-4 sm:p-5 text-[#5BC94D]">Jinko N-Type (Current Model)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/5 text-sm sm:text-base text-slate-300">
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Model Series</td>
                    <td className="p-4 text-[#5BC94D] font-bold">Jinko Tiger Neo 48HL4M-DV Dual Glass</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Cell technology</td>
                    <td className="p-4">N-type TOPCon monocrystalline (HOT 3.0 Technology)</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Peak wattage</td>
                    <td className="p-4">440W – 470W (in 5W steps)</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Module efficiency</td>
                    <td className="p-4">22.02% to 23.52%</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Temperature coefficient (Pmax)</td>
                    <td className="p-4">-0.29%/°C</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Panel dimensions</td>
                    <td className="p-4">1762 × 1134 × 30 mm</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Panel weight</td>
                    <td className="p-4">20.0 kg</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Annual degradation (Year 2+)</td>
                    <td className="p-4">0.40% per year (1% first-year degradation)</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Year 30 output guarantee</td>
                    <td className="p-4">87.4% of rated power</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Product warranty</td>
                    <td className="p-4 text-[#5BC94D] font-bold">25 years (includes labour cost coverage)</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Performance warranty</td>
                    <td className="p-4">30 years linear power warranty</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Cell design & Glass</td>
                    <td className="p-4">96 cells (48×2), 1.6mm Dual Glass (Anti-reflection & Heat Strengthened)</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Salt mist corrosion resistance</td>
                    <td className="p-4">Yes — certified</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">CEC approved</td>
                    <td className="p-4">Yes</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">STC rebate eligible</td>
                    <td className="p-4">Yes</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Cyclone rated</td>
                    <td className="p-4">Yes</td>
                  </tr>
                </tbody>
              </table>
      ...
      <section className="py-12 lg:py-24 bg-[#121814] border-b border-white/5 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white uppercase tracking-wide [word-spacing:0.12em] leading-[1.2] mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              {/* Point 5 */}
              <div className="group bg-slate-900/40 border border-white/5 hover:border-[#5BC94D]/30 hover:bg-slate-900/60 p-6 sm:p-8 rounded-3xl transition-all duration-300 shadow-xl hover:-translate-y-1.5 flex flex-col h-full md:col-span-2 lg:col-span-1">
                <div className="w-12 h-12 rounded-2xl bg-[#5BC94D]/10 border border-[#5BC94D]/20 text-[#5BC94D] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-12 lg:py-24 bg-[#0A1118] border-b border-white/5 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            {/* Comparison Table */}
            <div className="overflow-x-auto rounded-2xl border border-white/10 bg-slate-900/60 shadow-xl mb-8">
              <table className="w-full text-left border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-slate-950 border-b border-white/10 text-white font-black text-sm uppercase tracking-wider">
                    <th className="p-4 sm:p-5">Specification</th>
                    <th className="p-4 sm:p-5 text-[#5BC94D]">Jinko N-Type</th>
                ...
                <tbody className="divide-y divide-white/5 text-sm sm:text-base text-slate-300">
                  ...
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Temperature coefficient</td>
                  ...
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Year 25 output guarantee</td>
                    <td className="p-4">87.4%</td>
                    <td className="p-4">90.6%</td>
                    <td className="p-4">92%</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Labour warranty coverage</td>
                    <td className="p-4 text-[#5BC94D] font-bold">Yes</td>
                    <td className="p-4 text-slate-400">No</td>
                    <td className="p-4 text-slate-400">No</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Salt mist certified</td>
                    <td className="p-4">Yes</td>
                    <td className="p-4">Yes</td>
                    <td className="p-4">Yes</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">In Australia since</td>
                    <td className="p-4">Long established</td>
                    <td className="p-4">2024</td>
                    <td className="p-4">Long established</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors">
                    <td className="p-4 font-bold text-white">Best for NT</td>
                    <td className="p-4 font-bold text-[#5BC94D]">Proven value, low-light, local support</td>
            ...
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed font-medium">
              ...
              <RouterLink to="/solar-panels-brands/aiko/" className="text-[#5BC94D] hover:underline font-bold">
                AIKO solar panels page
              </RouterLink>
              . For the lowest temperature coefficient available, see our{" "}
              <RouterLink to="/product/solar-panels-brands" className="text-[#5BC94D] hover:underline font-bold">
          ...
          <FadeIn>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 text-lg sm:text-xl font-bold font-mono text-white">
              <a 
                ...
                className="flex items-center gap-3 hover:text-[#5BC94D] transition-colors"
              >
                <Phone className="w-6 h-6 text-[#5BC94D]" />
              ...
              <a 
                ...
                className="flex items-center gap-3 hover:text-[#5BC94D] transition-colors"
              >
                <Mail className="w-6 h-6 text-[#5BC94D]" />
