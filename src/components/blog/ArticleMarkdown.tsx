    ...
    <div className="blog-article-body">
      <Markdown
        components={{
          ...
          h2: ({ children }) => (
            <h2 className="text-[1.75rem] sm:text-[2rem] font-bold leading-[1.25] tracking-tight text-slate-900 mt-14 mb-5 normal-case">
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-[1.25rem] sm:text-[1.5rem] font-semibold leading-[1.3] text-slate-900 mt-10 mb-3 normal-case">
              {children}
            </h3>
          ),
          a: ({ href, children }) => {
